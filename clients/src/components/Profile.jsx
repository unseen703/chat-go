...
function Profile(props) {
  ...
  return (
    ...
    <div style={{ transition: showProfile ? "0.3s ease-in-out" : "" }} className={props.className}>
      <div className='  w-[100%]'>
        <div className='bg-[#f0f0f0] pt-12 pb-3'>
          <button onClick={() => dispatch(setShowProfile(false))} className='flex items-center'>
            ...
            <h6 className='text-[16px] text-["black"] font-semibold'>Profile</h6>
          </button>
        </div>
        <div className=' pt-5'>
          ...
          <div>
            ...
            <div className='py-2 px-4'>
              <p className='text-[10px] tracking-wide text-[#bdbdbd] '>
        ...
        <div onClick={logoutUser} className='flex items-center justify-center mt-2 cursor-pointer shadow-2xl'>
