...
function Contacts() {
  ...
  return (
    <>
      <div className='flex flex-col -space-y-1 overflow-y-scroll scrollbar-hide  pb-10'>
        {
              ...
              <div onClick={() => {
                ...
                <div className='flex items-center gap-x-3 sm:gap-x-1 md:gap-x-3'>
                  ...
                  <div >
                    ...
                    {(<img className='w-5 h-5  sm:w-5 sm:h-5 rounded-[30px] shadow-lg object-cover mr-2' src={e.latestMessage?.sender?.profilePic} alt="" />)
                    }
