...
import "./home.css"
import { fetchChats, setActiveChat, setNotifications } from '../redux/chatsSlice';
...
import { setSmallDeviceChat } from "../redux/chatsSlice"
          ...
          <div className={props.className}>
            ...
            <div className='flex justify-between items-center px-5 bg-[#ffff] w-[100%]'>
              <div className='flex items-center gap-x-[10px]'>
                <button onClick={() => dispatch(setActiveChat(''))} className='flex items-center pt-5 pb-3'>
                <IoArrowBack style={{ color: "black", width: "30px", height: "20px" }} />
                </button>
            ...
            <div className='absolute  left-[5%] sm:left[7%] md:left-[10%] lg:left-[20%] bottom-[8%]'>
              {
              ...
              <div className='border-x-[1px] border-b-[1px] bg-[#dce8ff] border-[#aabac8] px-6 py-3 w-[360px] sm:w-[400px] md:w-[350px] lg:w-[400px] rounded-b-[10px] h-[50px]'>
                {/* {
                ...
                <div className='flex justify-between items-start'>
                  ...
                  <div className='cursor-pointer' onClick={() => setShowPicker(!showPicker)}>
                    ...
                    {showPicker ? <BsFillEmojiSmileFill className='w-[20px] h-[20px] text-[#4399ff] border-[black]' /> : <BsEmojiSmile className='text-[#4399ff] w-[20px] h-[20px]' />}
                  </div>
                  <button onClick={(e) => keyDownFunction(e)} className='bg-[#4399ff] border-[2px] border-[#d4d4d4] text-[14px] px-2 py-[3px] text-[#fff] font-medium rounded-[7px] -mt-1'>Send</button>
                </div>
              </div>
            </div>
          </div> :
